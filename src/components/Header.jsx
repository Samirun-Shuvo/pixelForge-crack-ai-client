...
const Header = () => {
  ...
  return (
    <nav className="overflow-x-clip">
      {user && (
        <p className="text-center text-white bg-black py-2 bg-opacity-90 overflow-hidden whitespace-nowrap">
        <span className="inline-block animate-marquee">
          Welcome, {user?.displayName} 🎨✨! Dive in and explore all our AI-generated masterpieces.
        </span>
      </p>
      )}
      ...
      <div className="w-11/12 mx-auto py-5 flex justify-between items-center relative">
        <Link to="/" className="logo">
          <span className="text-xl font-bold text-stone-700">PixelForge</span>
        </Link>
